...
#                         [self.compression_layer] +
    ...
    def forward(self, x):
        ...
        # change the number of scales YOLO operates at
...
def main():
    ...
    #                                            encoder_params_dict={'quantizer' : 78},
    #                                            decoder_name='jpeg_image_decoder',
    #                                            decoder_params_dict={})
    # image_compression_layer = CompressionLayer(encoder_name='avc_encoder',
    #                                            encoder_params_dict={'quantizer' : 4},
    ...
    for img_path in args.image:
        ...
        for _ in range(32):
            ...
            times.append(t2-t1)
            print(t2-t1)
        print('final!', np.mean(np.asarray(times)))
