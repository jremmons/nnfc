...
// void conv_layer(Blob4D<float> &input, Blob4D<float> &output, H5::H5File &h5_file, std::string name){

//     std::string kernal_name = name + std::string(".weight");
//     std::string stride_name = name + std::string(".stride");
//     std::string zero_padding_name = name + std::string(".zero_padding");
    
//     H5::DataSet kernel = test_file.openDataSet(kernal_name.c_str());
//     H5::DataSet stride = test_file.openDataSet(stride_name.c_str());
//     H5::DataSet zero_padding = test_file.openDataSet(zero_padding_name.c_str());
...
//     NN::conv2d(input, kernel_blob, output, stride_, zero_padding_);
    
// }

// void bn_layer(Blob4D<float> &input, Blob4D<float> &output, std::string name){
...
int main(int argc, char* argv[]){
    ...
    conv_layer(input_blob, output_blob, )
