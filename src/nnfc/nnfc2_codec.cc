...
static constexpr int quanitizer_nbins_ = 4;
...
nnfc::NNFC2Encoder::NNFC2Encoder() : quantizer_(16) {}

nnfc::NNFC2Encoder::~NNFC2Encoder() {}

std::vector<uint8_t> nnfc::NNFC2Encoder::forward(const nn::Tensor<float, 3> input) const {
  ...
  std::vector<uint8_t> encoding(input.size());
