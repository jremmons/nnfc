...
struct DetBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "DetBackward"; }
  void release_variables() override {
    self_.reset_data();
    result_.reset_data();
  }
...
struct Log10Backward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "Log10Backward"; }
  void release_variables() override {
    self_.reset_data();
  }
...
struct Log2Backward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "Log2Backward"; }
  void release_variables() override {
    self_.reset_data();
  }
...
struct LogdetBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "LogdetBackward"; }
  void release_variables() override {
    self_.reset_data();
    result_.reset_data();
  }
...
struct SlogdetBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "SlogdetBackward"; }
  void release_variables() override {
    self_.reset_data();
    result0_.reset_data();
    result1_.reset_data();
...
struct SplitWithSizesBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "SplitWithSizesBackward"; }
  void release_variables() override {
    self_.reset_data();
  }
...
struct UniqueBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "UniqueBackward"; }
  void release_variables() override {
...
struct TrilinearBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "TrilinearBackward"; }
  void release_variables() override {
    i1_.reset_data();
    i2_.reset_data();
    i3_.reset_data();
...
struct ReluBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "ReluBackward"; }
  void release_variables() override {
    self_.reset_data();
  }
...
struct MaxPool3DBackwardBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "MaxPool3DBackwardBackward"; }
  void release_variables() override {
    indices_.reset_data();
  }
...
struct MkldnnConvolutionBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "MkldnnConvolutionBackward"; }
  void release_variables() override {
    self_.reset_data();
    weight_.reset_data();
  }
...
struct FftWithSizeBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "FftWithSizeBackward"; }
  void release_variables() override {
    self_.reset_data();
  }
