...
struct VariableType final : public at::Type {
  ...
  virtual Tensor & _standard_gamma_out(Tensor & output, const Tensor & self, Generator * generator) const override;
  ...
  virtual Tensor & log_softmax_out(Tensor & output, const Tensor & self, int64_t dim) const override;
  ...
  virtual Tensor & softmax_out(Tensor & output, const Tensor & self, int64_t dim) const override;
  ...
  virtual Tensor _cast_uint8_t(const Tensor & self, bool non_blocking) const override;
  virtual Tensor _cast_int8_t(const Tensor & self, bool non_blocking) const override;
  ...
  virtual Tensor _cast_int64_t(const Tensor & self, bool non_blocking) const override;
  virtual Tensor _cast_int16_t(const Tensor & self, bool non_blocking) const override;
  ...
  virtual Tensor diagonal(const Tensor & self, int64_t offset) const override;
  ...
  virtual Tensor embedding_bag_backward(const Tensor & grad, const Tensor & indices, const Tensor & offsets, const Tensor & offset2bag, const Tensor & bag_size, int64_t num_weights, bool scale_grad_by_freq, int64_t mode, bool sparse) const override;
  ...
  virtual Tensor expand(const Tensor & self, IntList size) const override;
  ...
  virtual Tensor sum(const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const override;
  virtual Tensor sum(const Tensor & self, int64_t dim, bool keepdim) const override;
  virtual Tensor sum(const Tensor & self, int64_t dim, ScalarType dtype) const override;
  virtual Tensor _sum(const Tensor & self, int64_t dim, bool keepdim) const override;
  virtual Tensor & sum_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const override;
  virtual Tensor & sum_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim) const override;
  virtual Tensor & sum_out(Tensor & result, const Tensor & self, int64_t dim, ScalarType dtype) const override;
