...
inline Tensor & dispatch_multi_margin_loss(const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, bool size_average, bool reduce, Tensor output) {

  AutoNoGIL no_gil;
  AutoGPU auto_gpu(output);
  return at::multi_margin_loss_out(output, self, target, p, margin, weight, size_average, reduce);
}
inline Tensor dispatch_multi_margin_loss(const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, bool size_average, bool reduce) {

  AutoNoGIL no_gil;
  AutoGPU auto_gpu(self);
  return at::multi_margin_loss(self, target, p, margin, weight, size_average, reduce);
}
